      ...
      <div className='text-center'>
        ...
        <div className='flex flex-col justify-center gap-4 sm:flex-row'>
          ...
          <button
            ...
            className='inline-flex items-center gap-2 rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-700 transition-colors duration-150 hover:border-gray-400 hover:text-gray-900'
          >
